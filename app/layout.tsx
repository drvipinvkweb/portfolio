...
export const metadata: Metadata = {
  title: "DR | Business and Startup Consultant",
  description: "Official portfolio of Vipin VK (DR), a leading Technologist, Startup Mentor, and Business Consultant specialized in scaling operations and precision execution across India and the Middle East.",
